...
Achievements = {
    ...
    { -- the_spike_of_all_time_minus
        ...
        quote = [[...while some climbers prefer to fully rely on their own strength.]],
        scoreSimp = function(spike) return floor(spike) .. " Spike" end,
    ...
    { -- ASDPGVrMSrNH
        ...
        desc = [[HFD WUT rNH rMS GV AS DP mods]],
    ...
    { -- the_oblivious_artist
        ...
        desc = [[Quests passed with using SPIN odd times, with DH rIN AS]],
    ...
    { -- the_spike_of_all_time_plus
        ...
        quote = [[...while some climbers prefer rewriting their destiny with the divine power.]],
        scoreSimp = function(spike) return floor(spike) .. " Spike" end,
