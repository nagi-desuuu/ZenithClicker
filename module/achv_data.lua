...
Achievements = {
    ...
    { -- the_spike_of_all_time
        ...
        desc = [[Largest spike sent (base attack, excluding Surge)]],
        quote = [[Flashy techniques are a staple amongst Zenith Tower's glory-seeking competitors.]],
        rank = numberRank(0, 8, 12, 16, 20, 26, 42),
    ...
    { -- the_spike_of_all_time_plus
        ...
        name = "The Spike of All Time+",
        desc = [[Largest spike sent (all attack, including Surge)]],
        quote = [[Flashy techniques are not the only answer.]],
