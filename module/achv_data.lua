...
Achievements = {
    ...
    { -- DHNHrASrIN
        ...
        id = 'DHNHrASrIN',
        name = "Steganography",
        desc = [[HFD with NH DH rIN rAS mods]],
    ...
    { -- DHGVNHrMS
        ...
        id = 'DHGVNHrMS',
        name = "Trench Warfare",
        desc = [[HFD with NH rMS GV DH mods]],
    ...
    { -- DPGVMSrNH
        ...
        id = 'DPGVMSrNH',
        name = "Grand-Master!",
        desc = [[HFD with rNH MS GV DP mods]],
        quote = [[YOUR AER: GRAND-MASTER!]],
        -- credit = "TGM4",
        rank = floorRank(1, 3, 5, 7, 9, 10, 1800),
        hide = function() return GAME.completion.NH == 0 end,
    },
    ...
    { -- ASEXrDHrMS
        ...
        desc = [[HFD with EX rMS rDH AS mods]],
    ...
    { -- swamp_water_lite_plus
        ...
        name = "Ambrosia Soda",
        desc = [[HFD WU 1 reverse mod + 6 mods ("Duo" not allowed)]],
    ...
    { -- swamp_water_pro_plus
        ...
        desc = [[HFD WU 1 reverse mod + 8 mods]],
    ...
    { -- the_escape_artist
        ...
        desc = [[Quests passed with wound triggered WUT "Double Hole", "Messiness" and "All-Spin" mods]],
    ...
    { -- the_oblivious_artist
        ...
        desc = [[Quests passed by using SPIN odd times, with DH rIN AS]],
    ...
    { -- divine_rejection
        ...
        desc = [[Finish the run just before F10]],
    ...
    { -- fel_magic
        ...
        id = 'fel_magic',
        name = "Fel Magic",
        desc = [[Quests passed while triggering wound during GIGASPEED, with rAS]],
    ...
    { -- arrogance
        ...
        id = 'arrogance',
        name = "Arrogance",
        desc = [[HAR with rAS and no perfect passes]],
    ...
    { -- honeymoon
        ...
        id = 'honeymoon',
        name = "Honeymoon",
        desc = [[HFD with every commit sharing at least one mod with previous, with at least (r)DP]],
    ...
    { -- overprotection
        ...
        id = 'overprotection',
        name = "Overprotection",
        desc = [[HFD while keeping both players' HP above 10 (max 15), with rDP]],
    ...
    { -- psychokinesis
        ...
        id = 'psychokinesis',
        name = "Psychokinesis",
        desc = [[HAR with 0 flip in the result]],
    ...
    { -- the_perfectionist
        ...
        desc = [[HFD without imperfect pass or getting hurt]],
    ...
    { -- superluminal
        ...
        id = 'superluminal',
        name = "Superluminal",
        desc = [[Reach F10 in 76.2s (max CR)]],
    ...
    { -- subjugation
        ...
        quote = [[Complete and utter dominance over anything and everything.]],
        type = 'issued',
        hide = TRUE,
    },
    { -- omnipotence
        ...
        quote = [[All-powerful proficiency in unparalleled velocity.]],
        credit = "@flomikel",
        type = 'issued',
        hide = TRUE,
    },
    ...
    { -- smooth_dismount
        ...
        desc = [[Reversing card animation ending in non-rev activated state]],
