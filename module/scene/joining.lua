...
function scene.update(dt)
    ...
    elseif t1 > 0 then
        ...
        if t1 <= 0 then
            ...
            SFX.load('f9end', 'assets/sfx/f9end.wav')
            SFX.load('f9rend', 'assets/sfx/f9rend.wav')
            SFX.load('teraend1', 'assets/sfx/teraend1.wav')
            SFX.load('teraend2', 'assets/sfx/teraend2.wav')
            SFX.load('teraend3', 'assets/sfx/teraend3.wav')
            SFX.load('teraend4', 'assets/sfx/teraend4.wav')
            SFX.load('teraendr', 'assets/sfx/teraendr.wav')
