...
Fatigue = {
    ...
    rDP = {
        ...
        { time = 60,   event = { 'dmgHeal', -.5 }, --[[ 1 ]]   text = "YOU FEELS NEGLECTED_",                       desc = "Heal---" },
        { time = 80,   event = { 'dmgHeal', 1 }, --[[ 2 ]]     text = "THEY SUCCESSFULLY APOLOGIZES_?",             desc = "Heal+" },
        { time = 100,  event = { 'dmgHeal', 1 }, --[[ 3 ]]     text = "THINGS ARE BACK TO HOW THEY USED TO BE_!",   desc = "Heal+++" },
        { time = 120,  event = { 'dmgHeal', -1 }, --[[ 2 ]]    text = "MINOR ISSUES BECOME LARGE CONFLICTS_",       desc = "Heal--" },
        { time = 140,  event = { 'dmgHeal', -1 }, --[[ 1 ]]    text = "YOU BLAMES THEY FOR THEIR OWN PROBLEMS_",    desc = "Heal---" },
        { time = 160,  event = { 'reviveCount', 3 },           text = "THEY WOULD RATHER SPEND TIME ALONE_",        desc = "Revive++" },
        { time = 180,  event = { 'dmgHeal', 1.5 }, --[[ 2.5 ]] text = "YOU PROMISES TO CHANGE_",                    desc = "Heal++" },
        ...
        { time = 260,  event = { 'dmgHeal', -.5 }, --[[ 1 ]]   text = "THEY SETS AN ULTIMATUM_",                    desc = "Heal--" },
        ...
        { time = 360,  event = { 'dmgHeal', 1 }, --[[ 1.5 ]]   text = "\"I MISS YOU\"",                             desc = "Heal+++" },
        { time = 380,  event = { 'dmgHeal', 1 }, --[[ 2.5 ]]   text = "MAYBE IT CAN STILL WORK_?",                  desc = "Heal+" },
        { time = 400,  event = { 'dmgTimeMul', -.4 },          text = "GOODBYE.",                                   desc = "TimerSpeed++++" },
        { time = 1e99, text = "" },
    },
}
