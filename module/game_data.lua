...
Fatigue = {
    ...
    rDP = {
        { time = 20,   event = { 'dmgHeal', -1 }, --[[ 3 ]]     text = "YOUR PASSION FADES_",                        desc = "Heal-" },
        { time = 40,   event = { 'dmgHeal', -1 }, --[[ 2 ]]     text = "THEIR REPLIES BECOME LESS ENGAGED_",         desc = "Heal--" },
        { time = 60,   event = { 'dmgHeal', -.5 }, --[[ 1.5 ]]  text = "YOU FEELS NEGLECTED_",                       desc = "Heal---" },
        { time = 80,   event = { 'dmgHeal', 1 }, --[[ 2.5 ]]    text = "THEY SUCCESSFULLY APOLOGIZES_?",             desc = "Heal+" },
        { time = 100,  event = { 'dmgHeal', 1.5 }, --[[ 4 ]]    text = "THINGS ARE BACK TO HOW THEY USED TO BE_!",   desc = "Heal+++" },
        { time = 120,  event = { 'dmgHeal', -1 }, --[[ 3 ]]     text = "MINOR ISSUES BECOME LARGE CONFLICTS_",       desc = "Heal--" },
        { time = 140,  event = { 'dmgHeal', -1.5 }, --[[ 1.5 ]] text = "YOU BLAMES THEY FOR THEIR OWN PROBLEMS_",    desc = "Heal---" },
        { time = 160,  event = { 'reviveCount', 3 },            text = "THEY WOULD RATHER SPEND TIME ALONE_",        desc = "Revive++" },
        { time = 180,  event = { 'dmgHeal', 2 }, --[[ 3.5 ]]    text = "YOU PROMISES TO CHANGE_",                    desc = "Heal++" },
        { time = 200,  event = { 'dmgTimeMul', -.3 },           text = "PROMISES ARE BROKEN_",                       desc = "TimerSpeed++" },
        { time = 220,  event = { 'dmgHeal', -1 }, --[[ 2.5 ]]   text = "CONVERSATIONS DEVOLVE TO SHOUTING MATCHES_", desc = "Heal---" },
        { time = 240,  event = { 'dmgHeal', -.5 }, --[[ 2 ]]    text = "ALL TRUST HAS WITHERED AWAY_",               desc = "Heal--" },
        { time = 260,  event = { 'dmgHeal', -.5 }, --[[ 1.5 ]]  text = "THEY SETS AN ULTIMATUM_",                    desc = "Heal--" },
        { time = 280,  event = { 'dmgHeal', -.5 }, --[[ 1 ]]    text = "YOU CAN'T BE BOTHERED ANYMORE_",             desc = "Heal--" },
        ...
        { time = 360,  event = { 'dmgHeal', 1.5 }, --[[ 2.5 ]]  text = "\"I MISS YOU\"",                             desc = "Heal+++" },
        { time = 380,  event = { 'dmgHeal', .5 }, --[[ 3 ]]     text = "MAYBE IT CAN STILL WORK_?",                  desc = "Heal+" },
        { time = 400,  event = { 'dmgTimeMul', -.3 },           text = "GOODBYE.",                                   desc = "TimerSpeed++++" },
        { time = 1e99, text = "" },
    },
}
...
RevivePrompts = {
    ...
    { rank = { 1, 3 }, prompt = 'commit_0_row',         target = 3,   short = "3 x Spam commit",         text = "Commit NOTHING\n3 times in a row" },
    ...
    { rank = { 1, 3 }, prompt = 'heal',                 target = 8,   short = "+8 HP",                   text = "Heal 8 hp" },
    { rank = { 2, 4 }, prompt = 'heal',                 target = 20,  short = "+20 HP",                  text = "Heal 20 hp" },
    ...
    { rank = { 2, 2 }, prompt = 'dmg_time',             target = 4,   short = "Take Dmg x 4",            text = "Take damage 4 times" },
    { rank = { 3, 3 }, prompt = 'dmg_time',             target = 8,   short = "Take Dmg x 8",            text = "Take damage 8 times" },
