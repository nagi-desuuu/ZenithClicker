...
ComboData = {
    ...
    { set = "MS VL DH",          name = "cheese factory" },
    ...
    { set = "MS VL DH",          name = "divine apprentice" },
    ...
    { set = "NH GV IN",          name = "the absolute grandmaster" },
    ...
    { set = "EX NH GV IN",       name = "jack of all trades" },
    ...
    { set = "EX NH GV VL DH AS", name = "spinny thingy" },
    ...
    { set = "EX NH MS GV VL DH", name = "diluted lite diet swamp water zero" },
}
