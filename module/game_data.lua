...
Fatigue = {
    ...
    rDP = {
        { time = 20,   event = { 'dmgHeal', -.5 },     text = "YOUR PASSION FADES_",                        desc = "MESS+" },
        { time = 40,   event = { 'dmgHeal', -.5 },     text = "THEIR REPLIES BECOME LESS ENGAGED_",         desc = "MESS++" },
        { time = 60,   event = { 'dmgHeal', -.5 },     text = "YOU FEELS NEGLECTED_",                       desc = "MESS+++" },
        { time = 80,   event = { 'dmgHeal', .5 },      text = "THEY SUCCESSFULLY APOLOGIZES_?",             desc = "MESS-" },
        { time = 100,  event = { 'dmgHeal', 1 },       text = "THINGS ARE BACK TO HOW THEY USED TO BE_!",   desc = "MESS---" },
        { time = 120,  event = { 'dmgHeal', -1 },      text = "MINOR ISSUES BECOME LARGE CONFLICTS_",       desc = "MESS++" },
        { time = 140,  event = { 'dmgHeal', -.5 },     text = "YOU BLAMES THEY FOR THEIR OWN PROBLEMS_",    desc = "MESS+++" },
        { time = 160,  event = { 'reviveCount', 3 },   text = "THEY WOULD RATHER SPEND TIME ALONE_",        desc = "REVIVE++" },
        { time = 180,  event = { 'dmgHeal', 1 },       text = "YOU PROMISES TO CHANGE_",                    desc = "MESS--" },
        { time = 200,  event = { 'dmgTimeMul', -.3 },  text = "PROMISES ARE BROKEN_",                       desc = "+4 PERMA" },
        { time = 220,  event = { 'dmgHeal', -.5 },     text = "CONVERSATIONS DEVOLVE TO SHOUTING MATCHES_", desc = "MESS+++" },
        { time = 240,  event = { 'dmgHeal', -.5 },     text = "ALL TRUST HAS WITHERED AWAY_",               desc = "MESS++" },
        { time = 260,  event = { 'dmgHeal', -.5 },     text = "THEY SETS AN ULTIMATUM_",                    desc = "MESS++" },
        { time = 280,  event = { 'dmgHeal', -.5 },     text = "YOU CAN'T BE BOTHERED ANYMORE_",             desc = "MESS++" },
        { time = 300,  event = { 'dmgWrong', 3 },      text = "ONE LAST PAINFUL ARGUMENT_",                 desc = "DMG+" },
        { time = 320,  event = { 'reviveCount', 260 }, text = "GOODBYE.",                                   desc = "NO REVIVE" },
        { time = 360,  event = { 'dmgHeal', 1 },       text = "\"I MISS YOU\"",                             desc = "MESS---" },
        { time = 380,  event = { 'dmgHeal', .5 },      text = "MAYBE IT CAN STILL WORK_?",                  desc = "MESS-" },
        { time = 400,  event = { 'dmgTimeMul', -.3 },  text = "GOODBYE.",                                   desc = "+12 PERMA" },
        { time = 1e99, text = "" },
    },
}
...
RevivePrompts = {
    ...
    { rank = { 1, 2 }, prompt = 'flip_single',          target = 10,  short = "Flip single 10",          text = "Flip single card\n10 times in a row" },
    { rank = { 2, 4 }, prompt = 'flip_single',          target = 20,  short = "Flip single 20",          text = "Flip single card\n20 times in a row" },
    { rank = { 1, 2 }, prompt = 'commit',               target = 6,   short = "Commit x 6",              text = "Commit 6 times" },
    { rank = { 2, 3 }, prompt = 'commit',               target = 15,  short = "Commit x 15",             text = "Commit 15 times" },
    { rank = { 3, 5 }, prompt = 'commit',               target = 30,  short = "Commit x 30",             text = "Commit 30 times" },
    { rank = { 1, 2 }, prompt = 'commit_$1',            target = 2,   short = "Commit $1 x 2",           text = "Commit 2 times\nwith $1",                     init = rndMod },
    { rank = { 3, 4 }, prompt = 'commit_$1',            target = 4,   short = "Commit $1 x 4",           text = "Commit 4 times\nwith $1",                     init = rndMod },
    ...
    { rank = { 1, 2 }, prompt = 'commit_0',             target = 2,   short = "Commit NOTHING x 2",      text = "Commit NOTHING\n2 times" },
    { rank = { 2, 4 }, prompt = 'commit_0',             target = 5,   short = "Commit NOTHING x 5",      text = "Commit NOTHING\n5 times" },
    { rank = { 4, 6 }, prompt = 'commit_0',             target = 8,   short = "Commit NOTHING x 8",      text = "Commit NOTHING\n8 times" },
    { rank = { 2, 5 }, prompt = 'commit_0_row',         target = 3,   short = "3 x Spam commit",         text = "Commit NOTHING\n3 times in a row" },
    { rank = { 3, 5 }, prompt = 'commit_no_conn',       target = 1,   short = "Commit no conn",          text = "Commit without consecutive cards",            cond = F6 },
    { rank = { 1, 4 }, prompt = 'commit_conn_2',        target = 1,   short = "Commit 2 conn",           text = "Commit with 2 consecutive cards",             cond = f5 },
    { rank = { 2, 4 }, prompt = 'commit_conn_3',        target = 1,   short = "Commit 3 conn",           text = "Commit with 3 consecutive cards",             cond = f5 },
    { rank = { 3, 5 }, prompt = 'commit_conn_4',        target = 1,   short = "Commit 4 conn",           text = "Commit with 4 consecutive cards" },
    ...
    { rank = { 1, 4 }, prompt = 'commit_1card',         target = 3,   short = "Commit 1 cards x 3",      text = "Commit 3 times with\n1 cards on first commit" },
    { rank = { 2, 5 }, prompt = 'commit_2card',         target = 4,   short = "Commit 2 cards x 4",      text = "Commit 4 times with\n2 cards on first commit" },
    { rank = { 3, 6 }, prompt = 'commit_3card',         target = 5,   short = "Commit 3 cards x 5",      text = "Commit 5 times with\n3 cards on first commit" },
    { rank = { 4, 6 }, prompt = 'commit_4card',         target = 4,   short = "Commit 4 cards x 4",      text = "Commit 4 times with\n4 cards on first commit" },
    { rank = { 5, 6 }, prompt = 'commit_5card',         target = 3,   short = "Commit 5 cards x 3",      text = "Commit 3 times with\n5 cards on first commit" },
    ...
    { rank = { 2, 4 }, prompt = 'pass_perfect',         target = 6,   short = "6 perf",                  text = "Pass 6 times perfectly" },
    { rank = { 5, 6 }, prompt = 'pass_perfect',         target = 12,  short = "12 perf",                 text = "Pass 12 times perfectly" },
    { rank = { 2, 4 }, prompt = 'pass_imperfect',       target = 6,   short = "6 im-perf",               text = "Pass 6 times imperfectly" },
    { rank = { 5, 6 }, prompt = 'pass_imperfect',       target = 12,  short = "12 im-perf",              text = "Pass 12 times imperfectly" },
    { rank = { 4, 5 }, prompt = 'pass_imperfect_row',   target = 3,   short = "3 Chain im-perf",         text = "Pass 3 times\nimperfectly in a row" },
    { rank = { 5, 6 }, prompt = 'pass_imperfect_row',   target = 8,   short = "8 Chain im-perf",         text = "Pass 8 times\nimperfectly in a row" },
    ...
    { rank = { 2, 3 }, prompt = 'pass_second',          target = 4,   short = "2nd quest x 4",           text = "Pass second quest 4 times" },
    { rank = { 3, 4 }, prompt = 'pass_second',          target = 8,   short = "2nd quest x 8",           text = "Pass second quest 8 times" },
    { rank = { 4, 5 }, prompt = 'pass_second',          target = 12,  short = "2nd quest x 12",          text = "Pass second quest 12 times" },
    { rank = { 2, 4 }, prompt = 'b2b_break_4',          target = 1,   short = "Break B2B x 4",           text = "Break B2B x 4" },
    { rank = { 3, 4 }, prompt = 'b2b_break_6',          target = 1,   short = "Break B2B x 6",           text = "Break B2B x 6" },
    { rank = { 4, 5 }, prompt = 'b2b_break_8',          target = 1,   short = "Break B2B x 8",           text = "Break B2B x 8" },
    { rank = { 4, 6 }, prompt = 'b2b_break_10',         target = 1,   short = "Break B2B x 10",          text = "Break B2B x 10" },
    ...
    { rank = { 1, 3 }, prompt = 'heal',                 target = 4,   short = "+4 HP",                   text = "Heal 4 hp" },
    { rank = { 2, 4 }, prompt = 'heal',                 target = 10,  short = "+10 HP",                  text = "Heal 10 hp" },
    { rank = { 1, 2 }, prompt = 'send',                 target = 6,   short = "Send 6",                  text = "Send 6 attacks" },
    { rank = { 3, 4 }, prompt = 'send',                 target = 14,  short = "Send 14",                 text = "Send 14 attacks" },
    { rank = { 5, 6 }, prompt = 'send',                 target = 26,  short = "Send 26",                 text = "Send 26 attacks" },
    ...
    { rank = { 5, 5 }, prompt = 'pass_windup_inb2b',    target = 1,   short = "Windup with B2B",         text = "Pass a windups\nduring one B2B charge",       cond = F9 },
    ...
    { rank = { 1, 2 }, prompt = 'dmg_time',             target = 4,   short = "Take Dmg x 4",            text = "Take damage 4 times" },
    { rank = { 3, 4 }, prompt = 'dmg_time',             target = 8,   short = "Take Dmg x 8",            text = "Take damage 8 times" },
    { rank = { 5, 5 }, prompt = 'dmg_time',             target = 12,  short = "Take Dmg x 12",           text = "Take damage 12 times" },
    { rank = { 2, 4 }, prompt = 'dmg_amount',           target = 10,  short = "-10 HP",                  text = "Take 10 damage in total" },
    { rank = { 4, 6 }, prompt = 'dmg_amount',           target = 20,  short = "-20 HP",                  text = "Take 20 damage in total" },
    { rank = { 3, 4 }, prompt = 'timedmg_time',         target = 2,   short = "Take Time Dmg x 2",       text = "Take time damage 2 times",                    cond = F6 },
    { rank = { 5, 6 }, prompt = 'timedmg_time',         target = 4,   short = "Take Time Dmg x 4",       text = "Take time damage 4 times",                    cond = F6 },
    { rank = { 3, 6 }, prompt = 'keep_health_full',     target = 4,   short = "Full HP 4 s",             text = "Keep HP full for 4 seconds",                  cond = F6 },
    { rank = { 4, 6 }, prompt = 'keep_health_safe',     target = 8,   short = "Safe HP 8 s",             text = "Keep HP safe for 8 seconds",                  cond = F6 },
    { rank = { 4, 5 }, prompt = 'keep_health_danger',   target = 3,   short = "Danger HP 3 s",           text = "Keep HP danger for 3 seconds",                cond = F6 },
    { rank = { 2, 5 }, prompt = 'keep_no_mouse',        target = 4,   short = "No mouse 4 s",            text = "No mouse for 4 seconds",                      cond = f5 },
    { rank = { 2, 4 }, prompt = 'keep_no_commit',       target = 6,   short = "No commit 6 s",           text = "No commit for 6 seconds",                     cond = f5 },
    { rank = { 3, 6 }, prompt = 'keep_no_cancel',       target = 8,   short = "No cancel 8 s",           text = "No cancel for 8 seconds" },
    { rank = { 2, 5 }, prompt = 'keep_no_keyboard',     target = 10,  short = "No keyboard 10 s",        text = "No keyboard for 10 seconds",                  cond = F6 },
    { rank = { 3, 5 }, prompt = 'keep_no_perfect',      target = 12,  short = "No perfect 12 s",         text = "No perfect for 12 seconds" },
    { rank = { 4, 6 }, prompt = 'keep_no_imperfect',    target = 14,  short = "No imperfect 14 s",       text = "No imperfect for 14 seconds",                 cond = F6 },
    { rank = { 3, 5 }, prompt = 'keep_no_reset',        target = 16,  short = "No reset 16 s",           text = "No reset for 16 seconds" },
}
