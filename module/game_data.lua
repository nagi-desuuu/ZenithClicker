...
RevivePrompts = {
    ...
    { rank = { 2, 5 }, prompt = 'keep_no_mouse',        target = 4,   short = "No mouse 4s",            text = "Don't touch mouse for 4 seconds",              cond = f5 },
    ...
    { rank = { 2, 5 }, prompt = 'keep_no_keyboard',     target = 10,  short = "No keyboard 10s",        text = "Don't touch keyboard for 10 seconds",          cond = F6 },
