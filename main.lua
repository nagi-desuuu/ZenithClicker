...
TEXTURE = {
    ...
    achievement = {
        ...
        iconQuad = {
            ...
            -- DHrEXrVL = aq(), -- Need New: Sweat and Ruin
            -- MSrDPrGV = aq(), -- Need New: Rushed Relationship
            ...
            -- honeymoon = aq(),
            -- break_up = aq(),
            patience_is_a_virtue = aq2(2, 4),
            -- fel_magic = aq(), -- Need New
            arrogance = aq(3, 5),
            the_unreliable_one = aq2(6, 1),
            ...
            worn_out = aq(6, 2),
            skys_the_limit = aq2(3, 1),
            superluminal = aq2(5, 1),
            mastery = aq2(1, 3),
            terminal_velocity = aq2(1, 3),
